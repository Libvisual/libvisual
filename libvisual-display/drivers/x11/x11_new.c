/* Libvisual-display X11 frontend - The display library for libvisual.
 * 
 * Copyright (C) 2004, 2005, 2006 Vitaly V. Bursov <vitalyvb@ukr.net> 
 *
 * Authors: Vitaly V. Bursov <vitalyvb@ukr.net>
 *
 * $Id: x11_new.c,v 1.6 2006-01-22 13:29:14 synap Exp $ x11_new.c,v 1.4 2005/02/12 18:17:28 vitalyvb Exp $
 *
