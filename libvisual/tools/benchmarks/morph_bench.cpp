...
class MorphBench : public LV::Tools::Benchmark {
public:
  MorphBench(std::string const &morph_name, unsigned int width,
             unsigned int height, VisVideoDepth depth)
      : Benchmark{"MorphBench"}, m_morph{LV::Morph::load(morph_name)} {
    if (!m_morph) {
