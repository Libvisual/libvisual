...
class VideoAlphaBlendBench : public LV::Tools::Benchmark {
public:
  VideoAlphaBlendBench(unsigned int width, unsigned int height,
                       VisVideoDepth depth)
      : Benchmark{"VideoAlphaBlendBench"}, m_src{LV::Video::create(
                                               width, height, depth)},
