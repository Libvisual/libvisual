...
class VideoScaleBench : public LV::Tools::Benchmark {
public:
  VideoScaleBench(unsigned int src_width, unsigned int src_height,
                  unsigned int dst_width, unsigned int dst_height,
                  VisVideoDepth depth, VisVideoScaleMethod method)
      : Benchmark("VideoScaleBench"), m_src{LV::Video::create(
                                          dst_width, dst_height, depth)},
        m_dst{LV::Video::create(src_width, src_height, depth)}, m_method{
                                                                    method} {}
...
std::unique_ptr<VideoScaleBench> make_benchmark(int &argc, char **&argv) {
  ...
  return std::make_unique<VideoScaleBench>(src_width, src_height, dst_width,
                                           dst_height, depth, method);
}
