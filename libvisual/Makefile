...
pkgdatadir = $(datadir)/libvisual
pkglibdir = $(libdir)/libvisual
pkgincludedir = $(includedir)/libvisual
top_builddir = .
...
ACLOCAL = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run autoconf
AUTOHEADER = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run autoheader
AUTOMAKE = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run automake-1.7
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2  -ggdb3 -Wall -Wmissing-braces -Wimplicit -Wunused -Wmissing-prototypes -Wno-unused-variable -O0
CPP = gcc -E
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEBUG_CFLAGS =  -ggdb3 -Wall -Wmissing-braces -Wimplicit -Wunused -Wmissing-prototypes -Wno-unused-variable
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = dlltool
DSYMUTIL = 
...
LIBVISUAL_INCLUDE_DIR = ${prefix}/include/libvisual-0.5
LIBVISUAL_PLUGINS_BASE_DIR = ${exec_prefix}/lib/libvisual-0.5
LIBVISUAL_VERSION_SUFFIX = 0.5
LIPO = 
LN_S = ln -s
LTLIBICONV = -liconv
LTLIBINTL = 
LTLIBOBJS = 
LV_THREAD_CFLAGS = 
LV_THREAD_LIBS = -lpthread
MAKEINFO = ${SHELL} /storage/code/libvisual/trunk/libvisual/missing --run makeinfo
...
PACKAGE_STRING = Libvisual Library 0.5.0
...
VERSION = 0.5.0
VISUAL_CFLAGS = 
VISUAL_LIBS = -lpthread -lm -ldl  -lvisual-0.5
...
install_sh = /storage/code/libvisual/trunk/libvisual/install-sh
...
CONFIG_CLEAN_FILES = libvisual.pc
DIST_SOURCES =
DATA = $(pkgconfig_DATA)
...
DIST_COMMON = README $(srcdir)/Makefile.in $(srcdir)/configure \
	...
	libvisual.pc.in ltmain.sh missing mkinstalldirs
...
libvisual.pc: $(top_builddir)/config.status libvisual.pc.in
