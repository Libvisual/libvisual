...
void visual_buffer_copy_to_data(VisBuffer *self, void *dest,
                                visual_size_t size) {
  visual_return_if_fail(self != nullptr);
  visual_return_if_fail(dest != nullptr);
...
void visual_buffer_put_data(VisBuffer *self, const void *data,
...
void visual_buffer_fill_with_pattern(VisBuffer *self, const void *data,
                                     visual_size_t size) {
  visual_return_if_fail(self != nullptr);
