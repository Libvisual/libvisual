...
//!
//! AlignedAllocator is an implementation of the C++ Allocator concept for use
...
bool operator==(AlignedAllocator<alignment, T> const &,
                AlignedAllocator<alignment, U> const &) {
  return true;
}
