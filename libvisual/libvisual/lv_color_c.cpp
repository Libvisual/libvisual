...
VisColor *visual_color_new() { return new LV::Color(); }

void visual_color_free(VisColor *color) { delete color; }
...
void visual_color_set_rgba(VisColor *color, uint8_t r, uint8_t g, uint8_t b,
                           uint8_t a) {
  visual_return_if_fail(color != nullptr);
