...
VisVideo *visual_video_new_with_buffer(int width, int height,
                                       VisVideoDepth depth) {
...
VisVideo *visual_video_new_wrap_buffer(void *buffer, int owner, int width,
...
VisVideo *visual_video_new_sub_by_values(VisVideo *src, int x, int y, int width,
                                         int height) {
  visual_return_val_if_fail(src != nullptr, nullptr);

  LV::VideoPtr self =
      LV::Video::create_sub(LV::VideoPtr(src), LV::Rect(x, y, width, height));
  if (self) {
    LV::intrusive_ptr_add_ref(self.get());
  }
...
VisVideo *visual_video_new_sub_with_boundary(VisRectangle *drect, VisVideo *src,
                                             VisRectangle *srect) {
  visual_return_val_if_fail(src != nullptr, nullptr);
...
void visual_video_set_compose_function(VisVideo *self,
...
VisVideoComposeFunc
visual_video_get_compose_function(VisVideo *self, VisVideo *src, int alpha) {
  visual_return_val_if_fail(self != nullptr, nullptr);
  visual_return_val_if_fail(src != nullptr, nullptr);
...
void visual_video_blit_area(VisVideo *self, VisRectangle *drect, VisVideo *src,
                            VisRectangle *srect, int alpha) {
  visual_return_if_fail(self != nullptr);
...
void visual_video_compose_area(VisVideo *self, VisRectangle *drect,
...
void visual_video_blit_scale_area(VisVideo *self, VisRectangle *drect,
                                  VisVideo *src, VisRectangle *srect, int alpha,
...
void visual_video_compose_scale_area(VisVideo *self, VisRectangle *drect,
                                     VisVideo *src, VisRectangle *srect,
                                     VisVideoScaleMethod scale_method,
                                     VisVideoComposeFunc compose_func) {
  visual_return_if_fail(self != nullptr);
  ...
  self->compose_scale(*drect, LV::VideoPtr(src), *srect, scale_method,
                      compose_func);
}
...
void visual_video_compose(VisVideo *self, VisVideo *src, int x, int y,
                          VisVideoComposeFunc compose_func) {
  visual_return_if_fail(self != nullptr);
  visual_return_if_fail(src != nullptr);
  visual_return_if_fail(compose_func != nullptr);
...
void visual_video_fill_alpha_area(VisVideo *self, uint8_t alpha,
                                  VisRectangle *area) {
  visual_return_if_fail(self != nullptr);
...
void visual_video_fill_color_area(VisVideo *self, VisColor *color,
                                  VisRectangle *area) {
  visual_return_if_fail(self != nullptr);
  visual_return_if_fail(color != nullptr);
  visual_return_if_fail(area != nullptr);
...
void visual_video_rotate(VisVideo *self, VisVideo *src,
...
void visual_video_mirror(VisVideo *self, VisVideo *src,
...
void visual_video_scale(VisVideo *self, VisVideo *src,
...
void visual_video_scale_depth(VisVideo *self, VisVideo *src,
                              VisVideoScaleMethod scale_method) {
  visual_return_if_fail(self != nullptr);
  visual_return_if_fail(src != nullptr);
...
VisVideo *visual_video_scale_depth_new(VisVideo *src, int width, int height,
                                       VisVideoDepth depth,
                                       VisVideoScaleMethod scale_method) {
  visual_return_val_if_fail(src != nullptr, nullptr);

  auto self = LV::Video::create_scale_depth(LV::VideoPtr(src), width, height,
                                            depth, scale_method);
  if (self) {
    LV::intrusive_ptr_add_ref(self.get());
  }
