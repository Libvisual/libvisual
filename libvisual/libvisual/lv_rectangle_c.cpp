...
VisRectangle *visual_rectangle_new_empty() { return new LV::Rect; }

void visual_rectangle_free(VisRectangle *self) { delete self; }

void visual_rectangle_set(VisRectangle *self, int x, int y, int width,
                          int height) {
  (void)x;
  (void)y;
  (void)width;
...
void visual_rectangle_clip(VisRectangle *result, VisRectangle *bounds,
                           VisRectangle *src) {
...
void visual_rectangle_denormalize_point(VisRectangle *self, float fx, float fy,
                                        int32_t *x, int32_t *y) {
  visual_return_if_fail(self != nullptr);
...
void visual_rectangle_denormalize_point_neg(VisRectangle *self, float fx,
...
void visual_rectangle_denormalize_points(VisRectangle *self,
                                         const float *fxlist,
...
void visual_rectangle_denormalise_points_neg(VisRectangle *self,
                                             const float *fxlist,
                                             const float *fylist,
