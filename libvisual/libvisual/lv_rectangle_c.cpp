...
extern "C" {
  ...
  {
      visual_return_val_if_fail (self != NULL, TRUE);
  ...
  {
      visual_return_if_fail (result != NULL);
      visual_return_if_fail (bounds != NULL);
      visual_return_if_fail (src    != NULL);
  ...
  {
      visual_return_if_fail (self != NULL);
      visual_return_if_fail (x != NULL);
      visual_return_if_fail (y != NULL);
