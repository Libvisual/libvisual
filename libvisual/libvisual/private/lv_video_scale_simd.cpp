  ...
  while (dst_pixel_row != dst_pixel_row_end) {
    ...
    while (dst_pixel != dst_pixel_end) {
      ...
      __asm__ __volatile__(
          "\n\t pxor %%mm7, %%mm7"
          /* Prefetching does not show improvement on my Duron (maybe due to its
             small cache?) */
          ...
          "#1\n\t psubusw   %%mm5, %%mm4" /* mm4 = [ 0x10-fracU | 0x10-fracU |
                                             fracU | fracU ] */
          ...
          "#2\n\t psubusw   %%mm3, %%mm6" /* mm6 = [ 0x10-fracV | fracV |
                                             0x10-fracV | fracV ] */
          "#4\n\t movq      %%mm1, %%mm3"
          ...
          "#6\n\t punpckhwd %%mm4, %%mm4" /* mm4 = [
                                             coef[1]|coef[1]|coef[0]|coef[0] ]
                                           */

          "#3\n\t punpckhbw %%mm7, %%mm2" /* mm2 = [ col[2] unpacked ] */
          "#5\n\t punpcklwd %%mm5, %%mm5" /* mm5 = [
                                             coef[2]|coef[2]|coef[3]|coef[3] ]
                                           */
          ...
          "#6\n\t movq      %%mm4, %%mm7"
          "#5\n\t punpcklwd %%mm6, %%mm6" /* mm6 = [
                                             coef[3]|coef[3]|coef[3]|coef[3] ]
                                           */

          "#6\n\t punpcklwd %%mm7, %%mm7" /* mm6 = [
                                             coef[1]|coef[1]|coef[1]|coef[1] ]
                                           */
          "#5\n\t pmullw    %%mm6, %%mm3" /* mm3 = [ coef[3] * col[3] unpacked ]
                                           */

          "#5\n\t punpckhwd %%mm5, %%mm5" /* mm5 = [
                                             coef[2]|coef[2]|coef[2]|coef[2] ]
                                           */
          ...
          : [pixel_u] "m"(src_pixel_rowu[u >> 16]),
            [pixel_l] "m"(src_pixel_rowl[u >> 16]), [fracu] "m"(fracU),
            [fracv] "m"(fracV));
