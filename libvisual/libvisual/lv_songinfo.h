...
LV_API int visual_songinfo_compare(VisSongInfo const *s1,
                                   VisSongInfo const *s2);

LV_API void visual_songinfo_set_type(VisSongInfo *songinfo,
...
LV_API void visual_songinfo_set_simple_name(VisSongInfo *songinfo,
                                            const char *name);
LV_API const char *visual_songinfo_get_simple_name(VisSongInfo const *songinfo);

LV_API void visual_songinfo_set_artist(VisSongInfo *songinfo,
                                       const char *artist);
