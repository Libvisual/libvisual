...
void visual_random_context_free(VisRandomContext *rcontext) { delete rcontext; }

void visual_random_context_set_seed(VisRandomContext *rcontext,
                                    VisRandomSeed seed) {
...
uint32_t visual_random_context_int_range(VisRandomContext *rcontext,
