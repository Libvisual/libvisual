...
int visual_math_is_power_of_2(int n) { return (n > 0) && !(n & (n - 1)); }
...
void visual_math_simd_mul_floats_float(float *LV_RESTRICT dest,
                                       const float *LV_RESTRICT src, float k,
                                       visual_size_t count) {
...
void visual_math_simd_add_floats_float(float *LV_RESTRICT dest,
                                       ...
                                       float adder, visual_size_t count) {
  simd_add_floats_float(dest, src, adder, (int)count);
}

void visual_math_simd_mul_floats_floats(float *LV_RESTRICT dest,
...
void visual_math_simd_floats_to_int32s_mul_float(int32_t *LV_RESTRICT ints,
  ...
  simd_floats_to_int32s_mul_float((uint32_t * LV_RESTRICT) ints, flts, k,
                                  (int)count);
}

void visual_math_simd_int32s_to_floats_mul_float(
    float *LV_RESTRICT flts, const int32_t *LV_RESTRICT ints, float k,
    visual_size_t count) {
  simd_int32s_to_floats_mul_float(flts, (const uint32_t *LV_RESTRICT)ints, k,
                                  (int)count);
}
...
void visual_math_simd_denorm_floats_to_int32s(int32_t *LV_RESTRICT ints,
                                              const float *LV_RESTRICT flts,
                                              float k, visual_size_t count) {
  simd_denorm_floats_to_int32s((uint32_t * LV_RESTRICT) ints, flts, k,
                               (int)count);
}
...
void visual_math_simd_denorm_neg_floats_to_int32s(int32_t *LV_RESTRICT ints,
                                                  ...
                                                  float k,
                                                  visual_size_t count) {
  simd_denorm_neg_floats_to_int32s((uint32_t * LV_RESTRICT) ints, flts, k,
                                   (int)count);
}
