 ...
 */
LV_API VisEvent *visual_event_new_keyboard(VisKey keysym, VisKeyMod keymod,
                                           VisKeyState state);
 ...
 * @return New event object
 */
LV_API VisEvent *visual_event_new_mousebutton(int button, VisMouseState state,
                                              int x, int y);
 ...
 * @return New event object
 */
LV_API VisEvent *visual_event_new_custom(int eid, int param_int,
                                         void *param_ptr);
