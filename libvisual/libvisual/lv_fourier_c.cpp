...
void visual_dft_free(VisDFT *dft) { delete dft; }
...
void visual_dft_log_scale(float *output, float const *input,
                          unsigned int size) {
  LV::DFT::log_scale(output, input, size);
}

void visual_dft_log_scale_standard(float *output, float const *input,
                                   unsigned int size) {
  LV::DFT::log_scale(output, input, size);
}

void visual_dft_log_scale_custom(float *output, float const *input,
