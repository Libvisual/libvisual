...
VisEventQueue *visual_event_queue_new() { return new LV::EventQueue; }

void visual_event_queue_free(VisEventQueue *self) { delete self; }
...
VisEvent *visual_event_new_keyboard(VisKey keysym, VisKeyMod keymod,
                                    VisKeyState state) {
...
VisEvent *visual_event_new_mousebutton(int button, VisMouseState state, int x,
                                       int y) {
  auto event = new LV::Event;
...
void visual_event_free(VisEvent *event) { delete event; }
