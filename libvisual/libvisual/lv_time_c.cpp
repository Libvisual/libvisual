...
VisTime *visual_time_new() { return new LV::Time; }

VisTime *visual_time_new_now() { return new LV::Time(LV::Time::now()); }
...
void visual_time_free(VisTime *self) { delete self; }
...
void visual_usleep(uint64_t usecs) { LV::Time::usleep(usecs); }

VisTimer *visual_timer_new() { return new LV::Timer; }

void visual_timer_free(VisTimer *self) { delete self; }
