...
/* yyresume: */
  ...
  fprintf(stderr, "Shifting token %s, storing: %c\n", yytname[yytoken], yylval.v.punctuator);
...
#line 43 "avs_parse.y"
  ...
  case 11:
#line 44 "avs_parse.y"
    { fprintf(stderr, "PP: %c\n",  yyvsp[-1].v.punctuator, yyvsp[0]);  yyval = yyvsp[0];  ;}
    break;

  case 12:
#line 45 "avs_parse.y"
    { fprintf(stderr, "PP: %c\n", yyvsp[-1].v.punctuator);    ;}
    break;
