...
PKG_CHECK_MODULES(LIBVISUAL ${LIBVISUAL_PKG}>=${Libvisual_FIND_VERSION})
...
IF(LIBVISUAL_FOUND)
  ...
  PKG_GET_MODULE_VAR("${LIBVISUAL_PKG}" pluginsbasedir PLUGIN_DIR)
  SET(LV_PLUGIN_DIR "${PLUGIN_DIR}" CACHE PATH "Plugin installation directory")

  PKG_GET_MODULE_VAR("${LIBVISUAL_PKG}" datadir DATA_DIR)
  SET(LV_PLUGIN_DATA_DIR "${DATA_DIR}" CACHE PATH "Plugin data directory")

  PKG_GET_MODULE_VAR("${LIBVISUAL_PKG}" localedir LOCALE_DIR)
  SET(LV_PLUGIN_LOCALE_DIR "${LOCALE_DIR}" CACHE PATH "Plugin translations directory")
