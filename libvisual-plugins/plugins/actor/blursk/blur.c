...
static int dither[MAXTRANSITION] = {
    1,   235, 36,  63,  520, 112, 191, 438, 451, 368, 272, 57,  208, 293, 543,
    523, 362, 409, 545, 346, 429, 138, 71,  247, 89,  228, 74,  553, 274, 394,
    395, 0,   349, 164, 364, 299, 320, 555, 167, 156, 106, 117, 127, 209, 155,
    201, 461, 524, 440, 51,  265, 542, 273, 387, 508, 199, 256, 359, 120, 56,
    136, 342, 7,   270, 550, 377, 214, 434, 66,  325, 303, 86,  249, 532, 531,
    393, 162, 221, 326, 116, 392, 94,  558, 502, 14,  188, 340, 476, 449, 198,
    163, 336, 306, 206, 250, 32,  419, 465, 390, 4,   144, 322, 111, 93,  245,
    253, 170, 480, 279, 105, 448, 175, 255, 288, 92,  259, 154, 237, 212, 517,
    81,  78,  282, 67,  562, 533, 435, 220, 77,  210, 213, 39,  217, 87,  510,
    418, 121, 145, 490, 82,  25,  560, 124, 297, 275, 453, 8,   430, 456, 487,
    530, 351, 378, 421, 143, 161, 307, 317, 263, 224, 327, 431, 142, 546, 345,
    115, 423, 352, 569, 50,  497, 439, 181, 244, 486, 108, 21,  223, 495, 159,
    44,  315, 330, 258, 24,  295, 150, 231, 278, 19,  329, 335, 232, 343, 491,
    192, 195, 528, 252, 474, 559, 424, 27,  45,  380, 52,  183, 318, 507, 509,
    370, 102, 193, 38,  400, 205, 432, 452, 298, 37,  148, 371, 291, 61,  468,
    356, 410, 152, 471, 443, 539, 257, 203, 484, 262, 88,  234, 341, 196, 139,
    385, 100, 241, 219, 348, 473, 355, 72,  475, 285, 384, 34,  289, 503, 347,
    567, 69,  216, 557, 157, 103, 396, 372, 3,   310, 40,  374, 500, 513, 64,
    240, 176, 178, 229, 204, 420, 442, 242, 354, 551, 29,  319, 514, 334, 324,
    397, 547, 186, 436, 399, 381, 149, 361, 276, 549, 286, 470, 165, 137, 312,
    379, 516, 403, 499, 466, 10,  375, 141, 493, 172, 304, 233, 407, 54,  113,
    79,  415, 450, 360, 309, 478, 413, 123, 98,  483, 290, 365, 564, 281, 73,
    544, 107, 189, 350, 35,  501, 23,  376, 254, 302, 540, 171, 554, 369, 84,
    26,  180, 109, 226, 230, 467, 433, 337, 131, 95,  18,  504, 187, 15,  227,
    344, 339, 207, 91,  556, 70,  469, 425, 541, 11,  457, 153, 248, 386, 488,
    99,  128, 308, 494, 537, 570, 296, 563, 404, 261, 65,  53,  238, 185, 140,
    447, 31,  46,  411, 76,  398, 126, 445, 184, 482, 90,  311, 518, 496, 135,
    271, 85,  12,  190, 382, 9,   292, 101, 130, 239, 16,  300, 388, 173, 17,
    28,  166, 122, 313, 561, 6,   236, 97,  60,  194, 174, 444, 357, 147, 49,
    323, 129, 125, 515, 485, 446, 406, 197, 338, 215, 459, 132, 218, 114, 200,
    202, 158, 333, 511, 522, 428, 119, 55,  58,  260, 13,  462, 33,  521, 565,
    373, 110, 481, 412, 416, 492, 269, 405, 267, 512, 548, 134, 80,  59,  460,
    284, 179, 498, 264, 479, 427, 454, 552, 2,   489, 314, 316, 417, 535, 455,
    463, 506, 366, 83,  287, 441, 41,  301, 160, 363, 519, 505, 566, 146, 305,
    414, 529, 525, 43,  472, 458, 536, 266, 280, 383, 222, 568, 534, 328, 47,
    401, 367, 332, 246, 389, 22,  277, 391, 527, 243, 133, 331, 75,  225, 437,
    321, 464, 48,  104, 402, 151, 30,  5,   42,  538, 96,  353, 268, 62,  182,
    68,  526, 422, 251, 294, 211, 426, 20,  118, 283, 177, 477, 358, 168, 408,
    169};
#else
#define MAXTRANSITION 149
static int dither[MAXTRANSITION] = {
    125, 58,  57,  118, 135, 10,  49,  19,  41,  42,  48,  140, 51,  76,  141,
    46,  27,  106, 47,  26,  22,  36,  62,  24,  74,  3,   61,  8,   45,  32,
    13,  0,   53,  67,  105, 145, 87,  144, 43,  64,  35,  115, 1,   130, 25,
    111, 120, 15,  71,  85,  40,  55,  88,  98,  129, 66,  82,  11,  68,  96,
    78,  37,  77,  126, 75,  34,  112, 113, 30,  99,  79,  100, 80,  122, 18,
    107, 33,  143, 95,  148, 102, 119, 2,   131, 123, 14,  16,  12,  70,  65,
    142, 133, 108, 127, 9,   17,  56,  28,  101, 4,   29,  63,  6,   50,  116,
    83,  137, 7,   97,  147, 117, 31,  54,  84,  94,  109, 72,  134, 124, 69,
    136, 21,  138, 44,  146, 139, 91,  20,  52,  38,  132, 86,  5,   73,  104,
    39,  92,  59,  81,  128, 93,  89,  114, 110, 90,  60,  103, 23,  121};
#endif
 ...
 */
static int rise(int offset) { return img_bpl; }
...
static int drain(int offset) { return -spiral(offset); }
 ...
 */
static int binary(int offset) { return offset; }
...
static int cylinder(int offset) {
  ...
  if (++salt >= 100)
    salt = 0;
  offset =
      (int)((double)salt / 100.0 +
            2.5 * sin((double)offset / (double)img_height * VISUAL_MATH_PI));
  return offset * img_bpl;
}
...
} styles[] = {{"Simple", simple, LOWER_NO, 0, FALSE, FALSE},
 ...
 */
int blur(BlurskPrivate *priv, int beat /* Boolean: is this a beat? */,
  ...
  case 'S':
    transition = 1 + MAXTRANSITION / 200;
    break;
  case 'M':
    transition = 1 + MAXTRANSITION / 50;
    break;
  case 'F':
    transition = 1 + MAXTRANSITION / 8;
    break;
  default:
  ...
  if (!strcmp(config.blur_style, "Random quiet")) {
    if (quiet)
      *stylename = '\0';
             ...
             styletransition < 0 && --stylekeeprandom < 0) {
    *stylename = '\0';
  }
  ...
  if (strcmp(config.blur_style, stylename) ||
      ...
      strcmp(config.blur_when, blurname) || newspectrum != isspectrum) {
    /* store the new info */
  ...
  case 'R': /* Reduced blur */
    ...
    switch (blur_phase) {
    case 1:
      blurfunc = loopreduced1;
      break;
    case 2:
      blurfunc = loopreduced2;
      break;
    case 3:
      blurfunc = loopreduced4;
      break;
    case 4:
      blurfunc = loopreduced3;
      break;
    default:
  ...
  while (transition > 0 && styletransition >= 0) {
    transition--;
    styletransition--;
    for (i = dither[styletransition]; i < blurlast; i += MAXTRANSITION) {
  ...
  if (stylelower && !styleprevlower)
    ...
    return (blurheight * (styletransition + 1)) / (6 * MAXTRANSITION);
...
char *blur_when_name(int i) {
  static char *names[] = {"No blur", "Reduced blur", "Full blur",    "Melt",
                          "Smear",   "Random blur",  "Blur on beats"};
