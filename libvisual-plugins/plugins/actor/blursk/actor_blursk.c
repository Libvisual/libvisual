...
static void act_blursk_requisition(VisPluginData *plugin, int *width,
                                   int *height);
...
static void act_blursk_render(VisPluginData *plugin, VisVideo *video,
                              VisAudio *audio);
...
const VisPluginInfo *get_plugin_info(void) {
  static VisActorPlugin actor = {.requisition = act_blursk_requisition,
...
static int act_blursk_init(VisPluginData *plugin) {
  ...
  visual_param_list_add_many(
      params,
      visual_param_new_color_rgb("color", N_("Color"), 0x00, 0xff, 0xff, NULL),
      visual_param_new_string("color_style", N_("Color style"), "Rainbow",
                              NULL),
      visual_param_new_string("signal_color", N_("Signal color"),
                              "Normal signal", NULL),
      visual_param_new_bool("contour_lines", N_("Contour lines"), FALSE, NULL),
      visual_param_new_bool("hue_on_beats", N_("Hue change on beats"), FALSE,
                            NULL),
      visual_param_new_string("background", N_("Background"), "Black bkgnd",
                              NULL),
      visual_param_new_string("blur_style", N_("Blur style"), "Random", NULL),
      visual_param_new_string("transition_speed", N_("Transition speed"),
                              "Medium switch", NULL),
      visual_param_new_string("blur_when", N_("When to blur"), "Full blur",
                              NULL),
      visual_param_new_string("blur_stencil", N_("Blur stencil"), "No stencil",
                              NULL),
      visual_param_new_string("fade_speed", N_("Fade speed"), "Medium fade",
                              NULL),
      visual_param_new_bool("slow_motion", N_("Slow motion"), FALSE, NULL),
      visual_param_new_string("signal_style", N_("Signal type"),
                              "Stereo spectrum", NULL),
      visual_param_new_string("plot_style", N_("Plot style"), "Line", NULL),
      visual_param_new_bool("thick_on_beats", N_("Thick on beats"), TRUE, NULL),
      visual_param_new_string("flash_style", N_("Flash style"), "No flash",
                              NULL),
      visual_param_new_string("overall_effect", N_("Overall effect"),
                              "Normal effect", NULL),
      visual_param_new_string("floaters", N_("Floaters"), "No floaters", NULL),
      visual_param_new_string("cpu_speed", N_("CPU speed"), "Fast CPU", NULL),
      visual_param_new_integer("beat_sensitivity", N_("Beat sensitivity"), 4,
                               visual_param_in_range_integer(0, 10)),
      visual_param_new_string("config_string", N_("Config string"), "", NULL),
      visual_param_new_string("show_info", N_("Show info"), "Never show info",
                              NULL),
      visual_param_new_integer("info_timeout", N_("Info timeout"), 4,
                               visual_param_in_range_integer(0, INT_MAX)),
      visual_param_new_bool("show_timestamp", N_("Show timestamp"), TRUE, NULL),
      NULL);
...
static void act_blursk_render(VisPluginData *plugin, VisVideo *video,
  ...
  visual_mem_copy(visual_video_get_pixels(video), priv->rgb_buf,
                  visual_video_get_size(video));
}
