...
static void act_jakdaw_requisition(VisPluginData *plugin, int *width,
                                   int *height);
...
static void act_jakdaw_render(VisPluginData *plugin, VisVideo *video,
                              VisAudio *audio);
static VisPalette *act_jakdaw_palette(VisPluginData *plugin);

const VisPluginInfo *get_plugin_info(void) {
  static VisActorPlugin actor = {.requisition = act_jakdaw_requisition,
  ...
  static VisPluginInfo info = {
      ...
      .plugname = "jakdaw",
      .name = "Jakdaw plugin",
      .author = N_("Original by: Christopher Wilson <Jakdaw@usa.net>, Port by: "
    ...
    case VISUAL_EVENT_PARAM:
      ...
      if (visual_param_has_name(param, "zoom mode")) {
        ...
        visual_log(VISUAL_LOG_DEBUG,
                   "New value for the plotter trigger param: %d",
                   visual_param_get_value_integer(param));
...
static VisPalette *act_jakdaw_palette(VisPluginData *plugin) { return NULL; }
...
static void act_jakdaw_render(VisPluginData *plugin, VisVideo *video,
  ...
  _jakdaw_plotter_draw(priv, visual_buffer_get_data(priv->pcmbuf),
