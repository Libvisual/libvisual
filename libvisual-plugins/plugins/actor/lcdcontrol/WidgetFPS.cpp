...
WidgetFPS::WidgetFPS(LCDCore *v, std::string n, Json::Value *section, int row,
                     int col, int layer)
    : Widget(v, n, section, row, col, layer, WIDGET_TYPE_SPECIAL) {
...
void WidgetFPS::Stop() { timer_->Stop(); }
