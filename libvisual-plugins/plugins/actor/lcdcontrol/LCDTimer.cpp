...
LCDTimer::LCDTimer(LCDEventFunc func, void *data, int duration,
                   bool repeating) {
  mDuration = duration;
...
LCDTimer::~LCDTimer() { delete mEvent; }
...
LCDTimer *LCDTimerBin::AddTimer(LCDEventFunc func, void *data, int duration,
                                bool repeating) {
