...
void lua::bool_arg_t::pack(lua_State *L) { lua_pushboolean(L, value_); }
...
void lua::int_arg_t::pack(lua_State *L) { lua_pushinteger(L, value_); }
...
std::string lua::string_arg_t::asString() { return value_; }
...
lua::args_t::~args_t() { std::for_each(begin(), end(), deleter()); }
