...
static int avs_data_serialize_container_dtor(VisObject *object) {
  ...
  visual_collection_set_destroyer(VISUAL_COLLECTION(&scont->layout),
...
char *avs_serialize_retrieve_palette_from_preset_section(char *section,
                                                         VisParamEntry *param) {
  int i;
  VisPalette pal;
...
char *avs_serialize_retrieve_color_from_preset_section(char *section,
                                                       VisParamEntry *param) {
  unsigned char r, g, b;
...
char *avs_serialize_retrieve_string_from_preset_section(char *section,
                                                        VisParamEntry *param) {
  char *string;
  int len;
  int i;
...
AVSSerializeContainer *avs_serialize_container_new() {
  ...
  visual_object_initialize(VISUAL_OBJECT(scont), TRUE,
                           avs_data_serialize_container_dtor);

  return scont;
}

int avs_serialize_container_add(AVSSerializeContainer *scont,
...
int avs_serialize_container_add_string(AVSSerializeContainer *scont,
                                       VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_byte(AVSSerializeContainer *scont,
                                     VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_byte_with_boundry(AVSSerializeContainer *scont,
                                                  VisParamEntry *param,
                                                  int boundry) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_byte_int_skip(AVSSerializeContainer *scont,
                                              VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_byte_int_skip_with_boundry(
    AVSSerializeContainer *scont, VisParamEntry *param, int boundry) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_int(AVSSerializeContainer *scont,
                                    VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_int_with_boundry(AVSSerializeContainer *scont,
                                                 VisParamEntry *param,
                                                 int boundry) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_palette(AVSSerializeContainer *scont,
                                        VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
int avs_serialize_container_add_color(AVSSerializeContainer *scont,
                                      VisParamEntry *param) {
  AVSSerializeEntry *sentry;
...
char *avs_serialize_container_deserialize(AVSSerializeContainer *scont,
                                          char *section) {
  AVSSerializeEntry *sentry;
  ...
  while ((sentry = visual_list_next(&scont->layout, &le)) != NULL) {
    ...
    case AVS_SERIALIZE_ENTRY_TYPE_BYTE:
      if (sentry->param != NULL) {
        visual_param_entry_set_integer(sentry->param,
                                       AVS_SERIALIZE_GET_BYTE(section));

        if (visual_param_entry_get_integer(sentry->param) > sentry->boundry &&
            sentry->boundry > 0) {
          visual_log(VISUAL_LOG_WARNING,
                     "A serialized entry did hit the upper value boundry");
    ...
    case AVS_SERIALIZE_ENTRY_TYPE_STRING:
      ...
      section = avs_serialize_retrieve_string_from_preset_section(
          section, sentry->param);

      break;

    case AVS_SERIALIZE_ENTRY_TYPE_COLOR:

      section = avs_serialize_retrieve_color_from_preset_section(section,
                                                                 sentry->param);
    ...
    case AVS_SERIALIZE_ENTRY_TYPE_PALETTE:
      ...
      section = avs_serialize_retrieve_palette_from_preset_section(
          section, sentry->param);
...
AVSSerializeEntry *
avs_serialize_entry_new_byte_with_boundry(VisParamEntry *param, int boundry) {
  AVSSerializeEntry *sentry;
...
AVSSerializeEntry *
avs_serialize_entry_new_byte_int_skip_with_boundry(VisParamEntry *param,
                                                   int boundry) {
  AVSSerializeEntry *sentry;
...
AVSSerializeEntry *
avs_serialize_entry_new_int_with_boundry(VisParamEntry *param, int boundry) {
  AVSSerializeEntry *sentry;
