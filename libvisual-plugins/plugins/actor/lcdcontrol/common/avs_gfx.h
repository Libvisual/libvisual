...
int avs_gfx_line_non_naieve_floats(VisVideo *video, float x1, float y1,
                                   float x2, float y2, VisColor *col);
int avs_gfx_line_non_naieve_ints(VisVideo *video, int x1, int y1, int x2,
                                 int y2, VisColor *col);
int avs_gfx_line_floats(VisVideo *video, float x1, float y1, float x2, float y2,
                        VisColor *col);
int avs_gfx_line_ints(VisVideo *video, int x1, int y1, int x2, int y2,
                      VisColor *col);
