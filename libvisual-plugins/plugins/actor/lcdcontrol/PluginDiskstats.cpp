...
double PluginDiskstats::Diskstats(std::string arg1, std::string arg2,
                                  int arg3) {
...
PluginDiskstats::PluginDiskstats(lua *script) {
  ...
  const char *header[] = {"major",         "minor",         "name",
                          "reads",         "read_merges",   "read_sectors",
                          "read_ticks",    "writes",        "write_merges",
                          "write_sectors", "write_ticks",   "in_flight",
                          "io_ticks",      "time_in_queue", NULL};
