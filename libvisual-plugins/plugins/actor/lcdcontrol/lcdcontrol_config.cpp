...
std::string lcdcontrol_config =
    ...
    "    \"widget_hddtemp\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"return 'IDE Temp: ' .. exec.Exec('hddtemp "
    "/dev/sda1 | cut -f 3 -d :', 999)\",\n"
    "        \"length\": 14,\n"
    "        \"align\": \"L\",\n"
    "        \"update\": 999\n"
    "    },\n"
    "    \"widget_FSSpace\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"fsspace_a = ((statfs.Statfs('/', "
    "'bavail')*statfs.Statfs('/', 'bsize'))/ 1024/ 1024);fsspace_b = "
    "((statfs.Statfs('/', 'bavail')*statfs.Statfs('/', 'bsize'))/1024/1024);c "
    "= '/ ' .. fsspace_a .. 'MB / ' .. fsspace_b .. ' MB'; return c;\n"
    "        \",\n"
    "        \"length\": 42,\n"
    "        \"align\": \"M\",\n"
    "        \"speed\": 30\n"
    ...
    "    \"widget_IDEIn\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"return diskstats.Diskstats('sda', "
    "'read_sectors', 100)/2048\",\n"
    "        \"prefix\": \"return 'In '\",\n"
    "        \"postfix\": \"return 'MB'\",\n"
    "        \"precision\": 2,\n"
    "        \"align\": \"R\",\n"
    ...
    "        \"expression\": \"return diskstats.Diskstats('sda', "
    "'read_sectors', 100)\",\n"
    "        \"expression2\": \"return diskstats.Diskstats('sda', "
    "'write_sectors', 100)\",\n"
    "        \"length\": 14,\n"
    "        \"direction\": \"E\",\n"
    "        \"style\": \"H\",\n"
    ...
    "    \"widget_WLANIn\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"return netdev.Fast('wlan0', 'Rx_bytes', "
    "500)/1024\",\n"
    "        \"prefix\": \"'OUT'\",\n"
    "        \"postfix\": \"'KB'\",\n"
    "        \"length\": 9,\n"
    ...
    "    \"widget_WLANOut\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"return netdev.Fast('wlan0', 'Tx_bytes', "
    "500)/1024\",\n"
    "        \"prefix\": \"'IN'\",\n"
    "        \"postfix\": \"'KB'\",\n"
    "        \"length\": 9,\n"
    ...
    "        \"expression\": \"return netdev.Fast('wlan0', 'Rx_bytes', "
    "500)\",\n"
    "        \"expression2\": \"return netdev.Fast('wlan0', 'Tx_bytes', "
    "500)\",\n"
    "        \"length\": 14,\n"
    "        \"direction\": \"E\",\n"
    "        \"style\": \"H\",\n"
    ...
    "    \"widget_Time\": {\n"
    "        \"type\": \"text\",\n"
    "        \"expression\": \"return time.Strftime('%a,%m/%d %H:%M:%S', "
    "time.Time())\",\n"
    "        \"length\": 20,\n"
    "        \"align\": \"C\",\n"
    "        \"update\": 10\n"
    ...
    "        \"morph-steps\": 5,\n"
    "        \"skip-actors\": "
    "\"gstreamer:gdkpixbuf:lcdcontrol:jess:oinksie:goom2k4:jakdaw\",\n"
    "        \"actor\": \"corona\",\n"
    "        \"input\": \"debug\",\n"
    "        \"morph\": \"slide_up\",\n"
    "        \"style\": \"pcm\",\n"
    ...
    "        \"align\": \"M\", \n"
    "        \"expression\": \"uname.Uname('sysname') + ' ' + "
    "uname.Uname('nodename') + ' ' + uname.Uname('release') + ' ' + "
    "cpuinfo.Cpuinfo('model name')\", \n"
    "        \"type\": \"text\", \n"
    "        \"speed\": 100, \n"
    "        \"length\": 16\n"
    "    }, \n"
    ...
    "    \"widget_wlan0\": {\n"
    "        \"align\": \"L\", \n"
    "        \"expression\": \"return netdev.Fast('wlan0', 'Tx_bytes', 100) "
    "/1024\", \n"
    "        \"precision\": 0, \n"
    "        \"type\": \"text\", \n"
    "        \"update\": 500, \n"
    ...
    "        \"direction\": \"E\", \n"
    "        \"expression\": \n"
    "\"return (netdev.Fast('wlan0', 'Rx_bytes', 500) + netdev.Fast('wlan0', "
    "'Tx_bytes', 500)) /1024\", \n"
    "        \"gap\": 1, \n"
    "        \"type\": \"histogram\", \n"
    "        \"update\": 500, \n"
    ...
    "        \"expression\": \"return (netdev.Fast('wlan0', 'Rx_bytes', 500) + "
    "netdev.Fast('wlan0', 'Tx_bytes', 500)) /1024\", \n"
    "        \"length\": 7, \n"
    "        \"style\": \"N\", \n"
    "        \"type\": \"bar\", \n"
    "        \"update\": 500\n"
