...
struct _PLUGIN_INFO {
   ...
   * I took all static variables from goom_update and put them here.. for the
   * moment.
   */
  struct {
    ...
    int drawLinesDuration;  /* duree de la transition entre afficher les lignes
                               ou pas */
  ...
  struct {
    void (*draw_line)(Pixel *data, int x1, int y1, int x2, int y2, int col,
                      int screenx, int screeny);
    void (*zoom_filter)(int sizeX, int sizeY, Pixel *src, Pixel *dest,
