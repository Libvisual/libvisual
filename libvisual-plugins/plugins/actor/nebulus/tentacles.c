...
static void drawtentacle(int step, GLfloat angle, GLfloat twistangle) {
  if (step == 19)
    return;
...
static void createtentacles(void) {
  cubedl = glGenLists(1);
...
static void drawtentacles(void) {
  /* GLfloat angle, twistangle; */
...
static void render_tentacles(void) {
