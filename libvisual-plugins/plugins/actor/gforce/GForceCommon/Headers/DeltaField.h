...
public:
  ...
  void SetSize(long inWidth, long inHeight, long inRowSize,
               bool inForceRegen = false);

  // Compute a small portion of the grad field.  Call GetField() to see if the
  // field finished.
  void CalcSome();
  ...
  //	Note:  If the field is not 100% calculated, it will finish calculating
  //and may take a couple seconds.
