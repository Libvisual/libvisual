...
/* Takes an arg list, looks for 'H', 'S', 'V' in terms of T, and I.  T
represents the system time index (in seconds) and I is the intensity param
value, ranging from 0 to 1, where all line drawing drawing draws an intensity
of 1.  */
