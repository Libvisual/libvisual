...
// ### If Mac, in your global header, define USE_DRAW_SPROCKETS 1 or
// USE_DISP_MGR 1 if you want full screeen ability!!!
// ### If Win, in your global header, define USE_DIRECTX 1 if you want full
// screeen ability!!!
...
public:
  ...
  // Returns true if this ScreenDevice is currently fullscreen (ie, if
  // EnterFullscreen has been called)
  inline bool IsFullscreen() { return mContextRef != 0; }

  // Use these fcns to enter & exit fullscreen mode.  ioSize contains the
  // desired screen size on entry and contains the final fullscreen res
  // dimentions upon return. inWin expands to fit fullscreen size if in Windows
  // *or* we're no using mac drawsprockets
