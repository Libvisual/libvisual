...
public:
  ...
  //	Returns left hand side of equation.  ie, the closer it is to zero, the
  //closer 	inPt is to being on this plane.  It's:  (this.Dot( inPt ) - mD)
  ...
  //	Assigns this plane with a normal parellel to inNormal and so that it
  //passes thru the pt: inD * unit(inNormal)
