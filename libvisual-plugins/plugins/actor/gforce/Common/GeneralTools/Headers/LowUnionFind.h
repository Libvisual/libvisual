...
/*
"Low" in contrast to HighUnionFind in that running time for Union() is O( N ),
so performace will drop as the number of nodes starts to get very high.
*/
...
public:
  ...
  //	Returns access to the largest union/subtree in this graph. 0 is returned
  //if there's
