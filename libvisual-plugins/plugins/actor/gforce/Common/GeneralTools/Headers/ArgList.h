...
class ArgList  {
	...
	public:
		...
		inline bool				ArgExists( unsigned long inArgID ) const								{ return FetchArg( inArgID ) != 0;			}
...
#endif
		inline bool				GetArg( unsigned long inArgID, unsigned long& outArg ) const			{ return GetArg( inArgID, (long&) outArg );		}
