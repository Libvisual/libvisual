...
/* *** Class usage note ***
        Whenever the client switches modes (ie. from writing to reading or vice
   versa), the client *must* call either seek() or seekEnd() (so that internal
