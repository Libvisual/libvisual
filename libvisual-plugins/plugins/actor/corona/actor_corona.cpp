...
const int PALETTEDATA[][NB_PALETTES] = {
    ...
    {8, 32, 0xff, 64, 0, 96, 0xff, 128, 0, 192, 0xff, 256,
     0}, // 13. blue lines on black
    {8, 32, 0xffffff, 64, 0, 96, 0xffffff, 128, 0, 192, 0xffffff, 256,
     0},                                        // 14. white lines on black
...
const VisPluginInfo *get_plugin_info() {
  ...
  info.author = "Jean-Christophe Hoelt <jeko@ios-software.com> and Richard "
                "Ashburn <richard.asbury@btinternet.com>";
  info.version = "0.1";
...
void lv_corona_render(VisPluginData *plugin, VisVideo *video, VisAudio *audio) {
  ...
  LV::VideoPtr vidcorona =
      LV::Video::wrap(priv->corona->getSurface(), false, video->get_width(),
                      video->get_height(), VISUAL_VIDEO_DEPTH_8BIT);
