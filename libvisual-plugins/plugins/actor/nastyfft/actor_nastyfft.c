...
static void lv_nastyfft_requisition(VisPluginData *plugin, int *width,
                                    int *height);
...
static void lv_nastyfft_render(VisPluginData *plugin, VisVideo *video,
                               VisAudio *audio);
...
const VisPluginInfo *get_plugin_info(void) {
  static VisActorPlugin actor = {.requisition = lv_nastyfft_requisition,
  ...
  static VisPluginInfo info = {
      ...
      .help =
          N_("This plugin shows nasty fft visualization effect using OpenGL"),
...
static VisPalette *lv_nastyfft_palette(VisPluginData *plugin) { return NULL; }
